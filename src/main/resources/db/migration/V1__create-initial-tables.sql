...
CREATE TABLE T_DRONES (
    ...
    STATUS VARCHAR2(150) CHECK (STATUS IN ('ATIVO', 'INATIVO', 'EM MANUTENÇÃO')) DEFAULT 'ATIVO',
    DATA_AQUISICAO DATE
);
...
CREATE TABLE T_SOLICITACOES (
    ...
    STATUS VARCHAR2(150) CHECK (STATUS IN ('PENDENTE', 'EM ANDAMENTO', 'CONCLUÍDA')) DEFAULT 'PENDENTE',
